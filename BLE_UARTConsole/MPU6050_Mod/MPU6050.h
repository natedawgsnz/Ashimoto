...
class MPU6050 {
     ...
     */
     char setAcceleroRange(char range);
     ...
     */
     bool write( char address, char data);
    ...
    *   クロックの設定(3bit)
    */
    char setClockSource(uint8_t clock);
    ...
    */
    ...
    char mpu_set_accel_fsr(char range);
    char mpu_set_gyro_fsr(char range);
